...
# очередное напоминание писать подобное впредь на линуксе и не ленится
cov = coverage(branch=True, omit=['C:/Users/Lacerate/est-a-tet/Lib/*', 'tests.py'], )
cov.start()
...
class TestCase(unittest.TestCase):
    ...
    def test_avatar(self):
        u = User(nickname='john', email='john@example.com')
        avatar = u.avatar(128)
        expected = 'https://www.gravatar.com/avatar/5e5a50bbdeae5fc6f832bb7b7b824603?s=128'
